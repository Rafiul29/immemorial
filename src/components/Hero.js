...
import {useGsapPhotoDroping,useGsapPhotoLevitate} from "../hooks/gsap"
...
const Hero = () => {
  ...
  useGsapPhotoDroping(photosArr)
  useGsapPhotoLevitate(photosArr,heroRef)

  return <section className="hero wrapper" ref={heroRef}>
   ...
   <div className="photos">
    ...
    ref={photo1Ref}
    style={{
      backgroundImage:'url("https://images.pexels.com/photos/10046283/pexels-photo-10046283.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")'
      }}></div>

    <div className="photo two" 
      ref={photo2Ref}
    style={{backgroundImage:'url("https://images.pexels.com/photos/6577903/pexels-photo-6577903.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")'}}>
    </div>
